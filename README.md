...
To run gulp, first install all dependencies through npm, then run the gulp commands to automatically create builds. Use the command 'gulp' to run the default build without automatic updating. Run 'gulp watch' to run Gulp with watched files and automatic browser refresh.
